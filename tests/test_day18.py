...
class Day01TestSuite(unittest.TestCase):
    ...
    def _test_part1(self, candidate, expected):
        self.assertEqual(day18.explode(candidate), expected)
    ...
    def _test_part1(self, filename, expected):
        f = open(filename)
        self.assertEqual(day18.part1(f.read().splitlines()), expected)
    ...
    def test_can_explode(self, candidate, expected):
        self.assertEqual(day18.can_explode(candidate), expected)
    ...
    def test_can_split(self, candidate, expected):
        self.assertEqual(day18.can_split(candidate), expected)
